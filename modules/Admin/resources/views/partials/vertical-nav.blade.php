<ul class="navbar-nav iq-main-menu" id="sidebar-menu">
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#" tabindex="-1">
            <span class="default-icon">{{ __('Home') }}</span>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('admin.user.create')) }}"
                    ...
                    <span class="item-name">{{ __('Add User') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('admin.user.index')) }}" href="{{ route('admin.user.index') }}">
                    <i class="icon">
                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                            fill="currentColor">
                            <g>
    ...
    @role('master_admin')
        <li class="nav-item">
            <a class="nav-link {{ activeRoute(route('admin.role_permission.index')) }}"
                ...
                <span class="item-name">{{ __('Role Permission') }}</span>
            </a>
        </li>
    @endrole

    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-admin-manage" role="button"
            aria-expanded="false" aria-controls="sidebar-admin-manage">
            <i class="icon">
                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <span class="item-name">{{ __('Admin Manage') }}</span>
            <i class="right-icon">
                <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        ...
        <ul class="sub-nav collapse" id="sidebar-admin-manage" data-bs-parent="#sidebar-menu">
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('admin.management.index')) }}"
                    ...
                    <span class="item-name">{{ __('Admin List') }}</span>
                </a>
            </li>
        </ul>
    </li>
