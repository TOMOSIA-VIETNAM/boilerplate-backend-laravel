                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="">
                            <a href="#" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3"
                                data-bs-toggle="modal" data-bs-target="#staticBackdrop" @click="resetForm">
                                <i class="btn-inner">
                            ...
                            <x-admin::modal.primary-modal id="staticBackdrop" size="modal-md">
                                <input type="hidden" id="permission-store-route"
                                    value="{{ route('admin.permission.store') }}">
                                <input type="hidden" id="permission-edit-route"
                                    value="{{ route('admin.permission.update', '') }}">
                                            ...
                                            <tr>
                                                <td>{{ $permission->name }}
                                                    <div style="float:right;">
                                                        <button type="button"
                                                            @click="setEditMode({{ json_encode($permission) }})"
                                                            ...
                                                            <form
                                                                action="{{ route('admin.permission.delete', $permission->id) }}"
                                                ...
                                                @foreach ($roles as $role)
                                                    <td class="text-center">
                                                        <input class="form-check-input-custom" type="checkbox"
                                                            ...
                                                            value='{{ $role->name }}'
                                                            {{ checkRolePermission($role, $permission->name) ? 'checked' : '' }}>
                                                    </td>
                                                @endforeach
                                            </tr>
                                        @endforeach
